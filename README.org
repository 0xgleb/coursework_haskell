...
The introduction up to this point is based on an article called "Learn Haskell Fast and Hard".cite:learnhaskellfastandhard
...
#+ATTR_LATEX: :align |r|p{3cm}|p{6cm}|p{7cm}| :environment longtable
| / | <30>                           | <30>                           | <30>                           |
|---+--------------------------------+--------------------------------+--------------------------------|
...
- The algorithm tracks its recursion depth, and if it decides it is taking too long (depth greater than 2 * lg n), it switches to a heap sort to maintain O(n lg n) worst case behavior. (This is what makes the algorithm introsort).cite:introspectivesort
#+END_QUOTE
