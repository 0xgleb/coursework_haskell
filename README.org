...
As you can see we didn't need a lot of code to solve the problem. If you take a look at the way the algorithm was described in English in [[sorting-design]] you'll see that the code I wrote does exactly that. We basically tell Haskell what we want to achieve and not how to achieve it.
